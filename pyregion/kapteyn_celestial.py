...
-----------------------------------------------------------------------
   """
   lon = d2r( n.asarray(longlat[:,0],'d').flatten() )
   lat = d2r( n.asarray(longlat[:,1],'d').flatten() )
...
-----------------------------------------------------------------------
   """
   x = n.asarray(xyz[0],'d').flatten()
   y = n.asarray(xyz[1],'d').flatten()
   z = n.asarray(xyz[2],'d').flatten()
